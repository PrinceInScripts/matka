...
<head>
  ...
  <title>Deposit Report | Admin</title>
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6"><h1>Deposit Report</h1></div>
          <div class="col-sm-6">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-4">
            <div class="info-box bg-success"><span class="info-box-icon"><i class="fas fa-check"></i></span>
              <div class="info-box-content"><span class="info-box-text">Approved Amount</span>
          ...
          <div class="col-md-4">
            <div class="info-box bg-primary"><span class="info-box-icon"><i class="fas fa-list"></i></span>
              <div class="info-box-content"><span class="info-box-text">Total Requests</span>
                <span class="info-box-number">{{ $deposits->count() }}</span></div>
            </div>
          </div>
        </div>

        <div class="card">
          <div class="card-header"><h3 class="card-title">All Deposit Requests</h3></div>
          <div class="card-body table-responsive p-0">
            <table id="depTable" class="table table-hover table-striped table-sm">
              <thead class="thead-dark">
                <tr><th>#</th><th>User</th><th>Phone</th><th>Amount</th><th>Mode</th><th>Txn ID</th><th>Status</th><th>Date</th></tr>
              </thead>
              <tbody>
...
<script>
$(function(){ $('#depTable').DataTable({responsive:true,autoWidth:false,order:[[7,'desc']],buttons:['csv','excel','print']}).buttons().container().appendTo('#depTable_wrapper .col-md-6:eq(0)'); });
</script>
</body>
</html>
