...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header"><div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>Full Sangam</h1></div>
...
<div class="callout callout-info mb-3">
      <h5><i class="fas fa-info-circle mr-2"></i>Full Sangam</h5>
      <p class="mb-0">Open Panna + Close Panna combination. 14400 total combinations, highest payout game.</p>
    </div>
...
$(function(){
  ...
  $('#btnFilter').on('click',function(){
    ...
    $.post('{{ route("admin.reports.user_bid_history.filter") }}',{
      ...
      session:$('#fSession').val(), game_type_id: 13
    })
    .done(function(r){
      dt.clear();
      var ta=0,tw=0,tp=0;
