...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header"><div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6"><h1>Jodi Digit</h1></div>
        <div class="col-sm-6"><ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
          <li class="breadcrumb-item active">Jodi Digit</li>
        </ol></div>
      </div>
    </div></section>
    <section class="content"><div class="container-fluid">
<div class="callout callout-info mb-3">
      <h5><i class="fas fa-info-circle mr-2"></i>Jodi Digit</h5>
      <p class="mb-0">Players bet on a pair of digits 00–99. Both open and close Ank combine to form the winning Jodi.</p>
    </div>
...
$(function(){
  ...
  $('#btnFilter').on('click',function(){
    ...
    $.post('{{ route("admin.reports.user_bid_history.filter") }}',{
      ...
      session:$('#fSession').val(), game_type_id: 2
    })
    .done(function(r){
      dt.clear();
      var ta=0,tw=0,tp=0;
